            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-sm font-semibold text-foreground">{tTemplates(`${tmpl.slug}.name`)}</div>
                  <p className="mt-1 text-xs text-muted-foreground">{tTemplates(`${tmpl.slug}.description`)}</p>
                </button>
              )
            })}
          </div>
